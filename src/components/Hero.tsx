  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        <p className="font-serif text-lg md:text-xl mb-12 text-muted-foreground max-w-2xl mx-auto">
          The Debating Society, NIT Durgapur presents the 7th edition of its legendary murder mystery debate competition.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button 
            ...
            className="font-typewriter text-lg px-8 py-6 bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg shadow-primary/50 transition-all hover:scale-105"
          >
            Register Your Team
          </Button>
          ...
          <Button 
            size="lg"
            variant="outline"
            className="font-typewriter text-lg px-8 py-6 border-2 border-accent text-accent hover:bg-accent hover:text-accent-foreground transition-all hover:scale-105"
          >
            View Case Files
          </Button>
        </div>
